...
export class UserRepository {
 ...
 async findByRole(
  ...
  async getTopByXp(limit: number = 3): Promise<Pick<User, 'user_id' | 'full_name' | 'email' | 'xp'>[]> {
  ...
  async getUserXp(userId: string): Promise<Pick<User, 'user_id' | 'full_name' | 'email' | 'xp'> | null> {
    return this.db.user.findUnique({
  ...
  async countUsersWithXpGreaterThan(xp: number): Promise<number> {
