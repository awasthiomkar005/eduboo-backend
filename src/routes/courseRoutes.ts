...
router.get('/top-picks/highest-selling', courseController.getTopSellingCourses);
router.get('/top-picks/lowest-selling', courseController.getLowestSellingCourses);
router.get('/getPurchasedCourses', authenticate, courseController.getPurchasedCourses);
router.get('/', courseController.getCourses);
router.get('/:courseId', courseController.getCourseById);
router.get('/:courseId/modules-with-chapters', courseController.getModulesWithChapters);
